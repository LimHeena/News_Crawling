...
class Crawler:
    ...
    def __init__(self) -> None:
        ...
        # 코멘트 #1 : sub_category를 생성자 함수에서 만들기
            ...
            while True: #date
                ...
                while True: #page
                    ...
                    for url in url_list: #한 링크씩 들어가기
                        ...
                        # 코멘트 #2 : 반복문 안에서 너무 긴 코드는 별도 함수로 분리
                        news_dict = self._get_news_info(soup, sub_num)
                        news_dict['url'] = url
    ...
    # 코멘트 #2 : 분리한 함수 (코드 복사하고 필요한 parameter만 잘 지정하면 됨 !)
    def _get_news_info(self, soup, sub_num):
        news_dict = {}
